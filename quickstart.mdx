...
<CardGroup cols={2}>
  <Card title="Explore the Dashboard" icon="chalkboard" href="/ai-panel/dashboard" cta="Open Dashboard Overview">
    Learn how to navigate your Dashboard, find your tools, manage files, and customize your workspace.
  </Card>
  <Card title="Discover AI Tools" icon="toolbox" href="ai-writing/ai-writer" cta="View Features">
  ...
  <Card title="Manage Your Account" icon="books" href="account/my-account" cta="See Tutorials">
    Learn how to update your profile, choose a subscription plan, and use the affiliate program.
  </Card>
  <Card title="Check FAQs" icon="block-question" href="faqs/user-faqs" cta="Visit FAQs">
    Need help? Find answers to common questions and tips for troubleshooting
  </Card>
</CardGroup>
