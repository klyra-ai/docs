...
To get started, go to the \*\*AI Connect \*\*group in the left panel and click on the **AI RSS** tab.

Follow these steps to generate content using your RSS feed:

### ✅ Step 1: Enter RSS URL

Paste a valid RSS feed URL into the **RSS URL** field.

> Example: `https://news.google.com/rss`

### ✅ Step 2: Fetch RSS Titles

Once the URL is entered, the tool will automatically fetch the **list of available article titles** from the feed.\
A dropdown will appear — select the title you want to generate content for.

### ✅ Step 3: Customize Output Settings

Now personalize how you want your content to be generated:

- **Language:** Select the output language (e.g., English, Spanish, French).
