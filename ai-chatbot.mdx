...
<Frame>
  ![Klyra AI Chatbots dashboard showing chatbot metrics, creation shortcuts, and an existing chatbot](/images/ai-chatbots/01-ai-chatbots-dashboard.png)
</Frame>
...
<Frame>
  ![Klyra AI Configure Chatbot step showing chatbot identity, instructions, messages, model, interaction type, and interface language](/images/ai-chatbots/02-configure-chatbot.png)
</Frame>
...
<Frame>
  ![Klyra AI Customize Styles step showing logo, avatar, colors, branding, timestamp, and widget position settings](/images/ai-chatbots/03-customize-styles.png)
</Frame>
...
<Frame>
  ![Klyra AI Add a Knowledge Base step showing URL, PDF, Text, Q&A, and Website URL training options](/images/ai-chatbots/04-add-knowledge-base.png)
</Frame>
...
<Frame>
  ![Klyra AI Embed and Integrate step showing chatbot embed code, width, height, and copy controls](/images/ai-chatbots/05-embed-and-integrate.png)
</Frame>
...
<Frame>
  ![Klyra AI Chatbot Channel step showing Telegram and WhatsApp channel options](/images/ai-chatbots/06-chatbot-channels.png)
</Frame>
