...
<Tabs>
  <Tab title="Text Detection">
    ...
    <img
      ...
      alt="Klyra AI Textract Text Detection Web"
      class="rounded-xl border border-gray-200 shadow-lg"
    />
  </Tab>
  <Tab title="Table Detection">
    ...
    <img
      ...
      alt="Klyra AI Textract Table Analysis Web"
      class="rounded-xl border border-gray-200 shadow-lg"
    />
  </Tab>
  <Tab title="Form Detection">
    ...
    <img
      ...
      alt="Klyra AI Textract Form Analysis Web"
      class="rounded-xl border border-gray-200 shadow-lg"
    />
  </Tab>
  <Tab title="Receipt Analysis">
    ...
    <img
      ...
      alt="Klyra AI Textract Receipt Analysis Web"
      class="rounded-xl border border-gray-200 shadow-lg"
    />
  </Tab>
</Tabs>
...
- **Financial Processing**: Extract line items, totals, and vendor names from invoices and receipts for faster bookkeeping.
- **HR and Payroll**: Digitize paystubs, contracts, and forms for quick record-keeping and compliance.
- **Healthcare**: Pull patient details, diagnoses, or lab results from scanned reports to streamline workflows.
- **Legal and Compliance**: Identify key clauses or obligations from contracts without manual scanning.
- **Archiving**: Convert paper-based records into searchable, structured digital files.
- **Data Entry Automation**: Eliminate manual input from forms, tables, or PDFs to save hours of labor.